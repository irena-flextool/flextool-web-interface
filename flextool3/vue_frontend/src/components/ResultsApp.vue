<template>
    <page name="Results" :index-url="indexUrl" :project-url="projectUrl" :edit-url="editUrl" :run-url="runUrl"
        ...
        <n-layout id="main-layout" has-sider position="absolute">
            <n-layout-sider>
                <results-scenario-list :project-id="projectId" :run-url="runUrl" :summary-url="summaryUrl"
                    :is-multi-selection="multiSelectScenarios" @scenario-select="loadResults" ref="scenarioList" />
            </n-layout-sider>
            <n-layout-content content-style="margin-left: 1em; margin-right: 1em">
                <n-tabs @update:value="setScenarioSelectionToSingleOrMulti">
                    <n-tab-pane name="Summary" display-directive="show:lazy">
                        <results-summary :project-id="projectId" :summary-url="summaryUrl" @ready="loadSummary"
                            ref="summary" />
                    </n-tab-pane>
