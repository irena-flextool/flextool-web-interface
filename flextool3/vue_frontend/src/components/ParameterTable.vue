...
function fetchParameterDefinitions(projectId, modelUrl, classId) {
  return Communication.fetchData('parameter definitions?', projectId, modelUrl, {
    class_id: classId
  }).then(function (data) {
  ...
  skeletonPromise.promise
    .then(function (skeleton) {
      ...
      if (entityId === undefined) {
        ...
        Communication.fetchData('parameter values?', projectId, modelUrl, {
          entity_id: entityId,
